...
class Table(object):
    ...
    def insert(self,idfiled=None, fieldvalue=None):
        ...
        try:
            ...
            log.logger.debug('Table Columns: %s' % self.columncls)
            ...
            log.logger.error('Exception at pytable insert(): %s ' % e)
            if cfg.application['app_exception_detail']:
                traceback.print_exc(limit=3, file=sys.stdout)
            return_json['insertResult'] = 'Error'
            return_json['insertError'] = 'Exception at pytable insert(): %s ' % e
        finally:
            session.close()
            scsession.remove()
    ...
    def update(self, filter=None, filterparam=None, fieldvalue=None):
        ...
        try:
            ...
            log.logger.error('Exception at pytable update(): %s ' % e)
            if cfg.application['app_exception_detail']:
                traceback.print_exc(limit=3, file=sys.stdout)
            return_json['updateResult'] = 'Error'
            return_json['updateError'] = 'Exception at pytable update(): %s ' % e
        finally:
            session.close()
            scsession.remove()
        return jsonable_encoder(return_json)
    ...
    def updatebyid(self, idfiled=None, idvalue=None, fieldvalue=None):
        ...
        try:
            ...
            log.logger.error('Exception at pytable updatebyid(): %s ' % e)
            if cfg.application['app_exception_detail']:
                traceback.print_exc(limit=3, file=sys.stdout)
            return_json['updateResult'] = 'Error'
            return_json['updateError'] = 'Exception at pytable updatebyid(): %s ' % e
        finally:
            session.close()
            scsession.remove()
        return jsonable_encoder(return_json)
    ...
    def selectbyid(self, idvalue, fieldlist=None, idfiled=None):
        ...
        try:
            ...
            log.logger.error('Exception at pytable selectbyid(): %s ' % e)
            if cfg.application['app_exception_detail']:
                traceback.print_exc(limit=3, file=sys.stdout)
            return_json['selectResult'] = 'Error'
            return_json['selectError'] = 'Exception at pytable selectbyid(): %s ' % e
        finally:
            session.close()
            scsession.remove()
        return jsonable_encoder(return_json)
    ...
    def delete(self, filter=None, filterparam=None):
        ...
        try:
            ...
            log.logger.error('Exception at pytable delete(): %s ' % e)
            if cfg.application['app_exception_detail']:
                traceback.print_exc(limit=3, file=sys.stdout)
            return_json['deleteResult'] = 'Error'
            return_json['deleteError'] = 'Exception at pytable delete(): %s ' % e
        finally:
            session.close()
            scsession.remove()
        return jsonable_encoder(return_json)
    ...
    def deletebyid(self, idfiled=None, idvalue=None):
        ...
        try:
            ...
            log.logger.error('Exception at pytable deletebyid(): %s ' % e)
            if cfg.application['app_exception_detail']:
                traceback.print_exc(limit=3, file=sys.stdout)
            return_json['deleteResult'] = 'Error'
            return_json['deleteError'] = 'Exception at pytable deletebyid(): %s ' % e
        finally:
            session.close()
            scsession.remove()
        return jsonable_encoder(return_json)
